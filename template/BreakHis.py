...
class TrainModel(object):
    def __init__(self, is_test):
        if is_test:
            full_trainloader = data_loader.get_train_loader('../datasets/BreakHis_data/train', batch_size=8, augment=True,shuffle=True, num_workers=4, pin_memory=True)
            testloader = data_loader.get_test_loader('../datasets/BreakHis_data/val', batch_size=8, shuffle=False,num_workers=4, pin_memory=True)
